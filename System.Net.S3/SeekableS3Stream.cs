...
namespace System.Net.S3
{
    public class SeekableS3Stream : Stream
    {
        ...
        IAmazonS3 _s3 = null;
        RequestPayer _requestPayer = null;

        public long TotalRead { get; private set; }
        public long TotalLoaded { get; private set; }

        public SeekableS3Stream(IAmazonS3 s3, string bucket, string key, RequestPayer requestPayer, long page = DEFAULT_PAGE_LENGTH, int maxpages = DEFAULT_MAX_PAGE_COUNT)
        {
            _s3 = s3;
            ...
            _metadata.ContentType = m.Headers["Content-Type"];
            _metadata.HttpStatusCode = m.HttpStatusCode;
        }
        ...
        public string ContentType => _metadata.ContentType;

        public HttpStatusCode HttpStatusCode => _metadata.HttpStatusCode;
